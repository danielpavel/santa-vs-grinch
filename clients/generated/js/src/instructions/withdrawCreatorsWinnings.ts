...
export const WITHDRAW_CREATORS_WINNINGS_DISCRIMINATOR = new Uint8Array([
  210, 104, 160, 53, 155, 35, 222, 249,
]);

export function getWithdrawCreatorsWinningsDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    WITHDRAW_CREATORS_WINNINGS_DISCRIMINATOR
  );
}
...
export function getWithdrawCreatorsWinningsInstructionDataEncoder(): Encoder<WithdrawCreatorsWinningsInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({
      ...value,
      discriminator: WITHDRAW_CREATORS_WINNINGS_DISCRIMINATOR,
    })
  );
}

export function getWithdrawCreatorsWinningsInstructionDataDecoder(): Decoder<WithdrawCreatorsWinningsInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getWithdrawCreatorsWinningsInstructionDataCodec(): Codec<
  WithdrawCreatorsWinningsInstructionDataArgs,
  WithdrawCreatorsWinningsInstructionData
> {
  return combineCodec(
    getWithdrawCreatorsWinningsInstructionDataEncoder(),
    getWithdrawCreatorsWinningsInstructionDataDecoder()
  );
}
...
export type ParsedWithdrawCreatorsWinningsInstruction<
  TProgram extends string = typeof SANTA_VS_GRINCH_PROGRAM_ADDRESS,
...
export function parseWithdrawCreatorsWinningsInstruction<
