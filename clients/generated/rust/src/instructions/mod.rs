...
//!
  ...
  pub(crate) mod r#update_bet_burn_percentage_bp;
  pub(crate) mod r#update_mystery_box_burn_percentage_bp;
  pub(crate) mod r#update_mystery_box_price;
  ...
  pub use self::r#update_bet_burn_percentage_bp::*;
  pub use self::r#update_mystery_box_burn_percentage_bp::*;
  pub use self::r#update_mystery_box_price::*;
